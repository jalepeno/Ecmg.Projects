'  ---------------------------------------------------------------------------------
'  ---------------------------------------------------------------------------------
'   Document    :  StartJobRunnerEventArgs.vb
...
Public Class StartJobRunnerEventArgs
...
#Region "Constructors"
  ...
  Friend Sub New(lpProcessInfo As ProcessStartInfo, lpJobBatchCount As Integer, lpJobSet As JobSet)
    Try
      mobjProcessInfo = lpProcessInfo
      mintJobBatchCount = lpJobBatchCount
      mobjJobSet = lpJobSet
    Catch ex As Exception
      ApplicationLogging.LogException(ex, Reflection.MethodBase.GetCurrentMethod())
      ' Re-throw the exception to the caller
