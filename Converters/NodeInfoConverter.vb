'  ---------------------------------------------------------------------------------
'  ---------------------------------------------------------------------------------
'   Document    :  NodeInfoConverter.vb
'   Description :  [type_description_here]
'   Created     :  6/2/2014 8:52:51 AM
...
#End If
        ...
        writer.WriteValue(lobjItem.Id.ToString())

        writer.WritePropertyName("name")
        writer.WriteValue(lobjItem.Name.ToString())

        writer.WritePropertyName("address")
        writer.WriteValue(lobjItem.Address.ToString())

        If Not String.IsNullOrEmpty(lobjItem.Description) Then
          writer.WritePropertyName("description")
          writer.WriteValue(lobjItem.Description)
        End If

        writer.WritePropertyName("createDate")
        writer.WriteValue(lobjItem.CreateDate.ToString("G", New CultureInfo("en-US")))

        writer.WritePropertyName("role")
        writer.WriteValue(lobjItem.Role.ToString())

        writer.WritePropertyName("status")
        writer.WriteValue(lobjItem.Status.ToString())

        writer.WritePropertyName("version")
        writer.WriteValue(lobjItem.Version.ToString())

        'writer.WritePropertyName("computerInfo")
        'writer.WriteRawValue(lobjItem.ComputerInfo.ToJson())
